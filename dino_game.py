...
class ChromeDinoGame:
	...
	def __get_game_canvas(self) -> Image:
		"""create an PIL.Image about the canvas of the trex game, and return it as an image object
	...
	def close(self) -> None:
		"""function to close the driver's window for easy reusability of the code
